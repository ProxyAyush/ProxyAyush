...
| **[Antigravity Fusion Plugin](https://github.com/ProxyAyush/antigravity-fusion-plugin)** | Multi-model fusion for Antigravity, Claude Code, and Codex CLI. | `COMPLETED` |
